...
public class Waypoint : MonoBehaviour
{
	...
	public float scale_animation				= 1.5f;	
	public float scale_idle_min 				= 0.5f;
	public float scale_idle_max 				= 1.0f;
	public float scale_focus_min				= 1.0f;
	public float scale_focus_max				= 1.7f;
